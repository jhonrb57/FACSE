...
namespace FasceMVC.Models
{
    ...
    public class Totales
    {
        public Totales()
        {
            Total = null;
            TotalEnLetras = null;
            TotalEnLetrasSinRetencion = null;
            SubTotal = null;
            Cargos = null;
            Descuentos = null;
        ...
        public string TotalEnLetrasSinRetencion { get; set; }
        public string SubTotal { get; set; }
        public string Cargos { get; set; }
    ...
    public class EmisorRecepcion
    {
        ...
        [DataType(DataType.Date), DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{yyyy-MM-dd}")]
