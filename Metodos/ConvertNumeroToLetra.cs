...
namespace Metodos
{
    public class ConvertNumeroToLetra
    {
        /// <summary>
        /// Convierte el número en letras, es el método principal
        /// </summary>
        ...
        public string Enletras(string num)
        {
            ...
            if (decimales > 0)
            {
                dec = " CON " + ToText(Convert.ToDouble(decimales)) + dec;
        ...
        /// <summary>
        /// Convierte el número a texto se usa varias veces para poder convertir el número a letras
        /// </summary>
